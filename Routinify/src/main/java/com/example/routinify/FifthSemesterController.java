...
public class FifthSemesterController implements Initializable {

    @FXML
    private GridPane fifthSemGridpane;
    @FXML
    Parent root;
    @FXML
    Scene scene;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        for(int i=1;i<=5;i++){
            for(int j=1;j<=5;j++){
                MyVbox myVbox=new MyVbox(1);
                fifthSemGridpane.add(myVbox,i,j);
