...
public class FourthSemesterController implements Initializable {

    @FXML
    private GridPane fourthSemGridpane;
    @FXML
    Parent root;
    @FXML
    Scene scene;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        for(int i=1;i<=5;i++){
            for(int j=1;j<=5;j++){
                MyVbox myVbox=new MyVbox(4);
                fourthSemGridpane.add(myVbox,i,j);
